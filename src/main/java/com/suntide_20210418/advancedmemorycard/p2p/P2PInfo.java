...
public class P2PInfo {
    ...
    public P2PInfo(boolean isActive, boolean isOutput, boolean isConnected, boolean isMEP2P,
                   boolean isPendingBind, int channel, int maxChannel, String frequency, String name,
                   String p2pType, String dimension, int dimensionId, BlockPos position, ForgeDirection direction) {
    ...
    public boolean isMEP2P() { return isMEP2P; }
    public boolean isPendingBind() { return isPendingBind; }
    ...
    public boolean equals(Object o) {
        ...
        return isActive == p2PInfo.isActive && isOutput == p2PInfo.isOutput
                && isConnected == p2PInfo.isConnected && isMEP2P == p2PInfo.isMEP2P
                && isPendingBind == p2PInfo.isPendingBind && channel == p2PInfo.channel
                && maxChannel == p2PInfo.maxChannel && Objects.equals(frequency, p2PInfo.frequency)
                && Objects.equals(name, p2PInfo.name) && Objects.equals(p2pType, p2PInfo.p2pType)
                && Objects.equals(dimension, p2PInfo.dimension) && dimensionId == p2PInfo.dimensionId
    ...
    @Override
    public int hashCode() {
        return Objects.hash(isActive, isOutput, isConnected, isMEP2P, isPendingBind, channel,
                maxChannel, frequency, name, p2pType, dimension, dimensionId, position, direction);
    }
