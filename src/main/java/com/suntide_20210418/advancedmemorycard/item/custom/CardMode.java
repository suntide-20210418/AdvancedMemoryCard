...
public abstract class CardMode {
     ...
     */
    public abstract EnumActionResult onItemUseFirst(ItemStack stack, EntityPlayer player, World world,
    ...
    /** Called from onItemRightClick in AdvancedMemoryCardItem (main/sub hand aware) */
    public abstract ActionResult<ItemStack> onItemUse(World world, EntityPlayer player, EnumHand hand);
}
