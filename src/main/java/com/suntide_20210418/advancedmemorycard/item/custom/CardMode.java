...
public abstract class CardMode {
   ...
   *
   * <p>Called before the item's actually used on the part/block so it can be cancelled or modified
   * to change what the default {@link appeng.items.tools.MemoryCardItem} behavior is.
   */
   ...
   *
   * <p>Overriders should call this super method and use the returned tag to put in data. Overriders
   * should then return that same tag so subclasses can use it.
   *
   * @param tag
   * @return
   */
