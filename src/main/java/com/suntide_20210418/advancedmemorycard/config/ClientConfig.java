...
public class ClientConfig {
    ...
    public ClientConfig(Configuration config) {
        ...
        rotateHeadOnHighlight = config
            .getBoolean("rotateHeadOnHighlight", "client.highlight", true, "高亮 P2P 设备时是否自动转头面向该设备");
        p2pHighlightDurationSec = config
            .getInt("p2pHighlightDurationSec", "client.highlight", 5, 1, 60, "P2P 设备高亮渲染的持续时间（秒），默认 5");

        config.addCustomCategoryComment("client.treeColors", "P2P 树控件颜色设置 (ARGB)");
        treeColorBg = config
            .getInt("bg", "client.treeColors", 0xFFADB0C4, Integer.MIN_VALUE, Integer.MAX_VALUE, "树控件背景色");
        treeColorSelected = config
            .getInt("selected", "client.treeColors", 0xFF4A6EA9, Integer.MIN_VALUE, Integer.MAX_VALUE, "选中行背景色");
        treeColorHover = config
            .getInt("hover", "client.treeColors", 0xFF3A5A8A, Integer.MIN_VALUE, Integer.MAX_VALUE, "悬停行背景色");
        ...
        treeChannelWarningThreshold = config
            .getInt("channelWarningThreshold", "client.treeLayout", 8, 0, 128, "频道剩余数低于此值显示黄色警告");
        treeP2PNameMaxLength = config
            .getInt("p2pNameMaxLength", "client.treeLayout", 20, 5, 100, "P2P 设备名称最大显示长度（超出截断）");

        config.addCustomCategoryComment("client.panelColors", "详情面板颜色设置 (ARGB)");
        panelColorBg = config
            .getInt("bg", "client.panelColors", 0xFF9A9FB4, Integer.MIN_VALUE, Integer.MAX_VALUE, "面板背景色");
        panelColorTitle = config
            .getInt("title", "client.panelColors", 0xFFFFFFFF, Integer.MIN_VALUE, Integer.MAX_VALUE, "标题文字颜色");
        panelColorLabel = config
            .getInt("label", "client.panelColors", 0xFF000000, Integer.MIN_VALUE, Integer.MAX_VALUE, "标签文字颜色");
        panelColorValue = config
            .getInt("value", "client.panelColors", 0xFFFFFFFF, Integer.MIN_VALUE, Integer.MAX_VALUE, "值文字颜色");
        panelColorPlaceholder = config
            .getInt("placeholder", "client.panelColors", 0xFF888888, Integer.MIN_VALUE, Integer.MAX_VALUE, "占位符文字颜色");
        panelColorSeparator = config
            .getInt("separator", "client.panelColors", 0xFF888888, Integer.MIN_VALUE, Integer.MAX_VALUE, "分隔线颜色");
        panelColorButtonAreaBg = config
            .getInt("buttonAreaBg", "client.panelColors", 0xFF9A9FB4, Integer.MIN_VALUE, Integer.MAX_VALUE, "按钮区域背景色");
        config.addCustomCategoryComment("client.panelColors.status", "详情面板状态颜色");
        panelStatusNotActive = config.getInt(
            "notActive",
            "client.panelColors.status",
            0xFF000000,
            Integer.MIN_VALUE,
            Integer.MAX_VALUE,
            "未激活状态颜色");
        panelStatusNotConnected = config.getInt(
            "notConnected",
            "client.panelColors.status",
            0xFFFC5454,
            Integer.MIN_VALUE,
            Integer.MAX_VALUE,
            "未连接状态颜色");
        panelStatusConnected = config.getInt(
            "connected",
            "client.panelColors.status",
            0xFF54FC54,
            Integer.MIN_VALUE,
        ...
        panelInfoAreaHeightRatio = config
            .getInt("infoAreaHeightRatio", "client.panelLayout", 3, 1, 10, "信息区高度比例分子（3/4）");
        ...
        buttonColorBg = config
            .getInt("bg", "client.buttonColors", 0xFF7E8299, Integer.MIN_VALUE, Integer.MAX_VALUE, "按钮默认背景色");
        buttonColorHover = config
            .getInt("hover", "client.buttonColors", 0xFF3A5A8A, Integer.MIN_VALUE, Integer.MAX_VALUE, "按钮悬停背景色");
        buttonColorClick = config
            .getInt("click", "client.buttonColors", 0xFF2A4A7A, Integer.MIN_VALUE, Integer.MAX_VALUE, "按钮点击按下背景色");
        buttonColorText = config
            .getInt("text", "client.buttonColors", 0xFFFFFFFF, Integer.MIN_VALUE, Integer.MAX_VALUE, "按钮文字颜色");
        ...
        copySelectionSecond = config
            .getInt("second", "client.copyColors.selection", 0xFFFFFF, 0, 0xFFFFFF, "选择第二个点状态颜色");
