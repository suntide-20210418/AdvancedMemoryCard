...
### 🔧 核心功能
- **批量复制模式** - 选择区域范围，一次性复制多个AE2设备的配置
- **配置模式** - 传统单设备配置功能
- **智能模式切换** - Shift+滚轮快速切换不同工作模式
- **可视化选择** - 直观的区域选择和状态提示

### 🎯 使用方法

#### 批量复制模式
1. 手持高级内存卡，Shift+右键复制单个AE2设备配置
2. 普通右键选择要复制的第一个角落位置
3. 再次右键选择对角位置，完成区域选择
4. 对着空气右键批量应用配置到区域内所有AE2设备

#### 模式切换
- **Shift+右键** - 切换模式

#### 配置模式
- 传统的AE2内存卡功能，用于单设备配置管理
